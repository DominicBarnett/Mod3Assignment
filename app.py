...
def compliments_results():
    ...
    context = {
        ...
        'random_compliments': random.sample(list_of_compliments, int(request.args.get('num_compliments'))),
    }
...
def animal_facts():
    ...
    context = {
        ...
        'name_list' : animal_to_fact.keys(),
        'chosen_animal_fact': animal_to_fact.get(request.args.get('animal')),
...
API_KEY = 'AIzaSyAaHyrpL95bPbA2rTeUwJw0wP0XR4lWwFI'
print(API_KEY)
